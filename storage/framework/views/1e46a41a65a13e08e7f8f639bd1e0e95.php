<?php $__env->startSection('content'); ?>
    <section class="section">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.contact2.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/admin/contact2/index.blade.php ENDPATH**/ ?>