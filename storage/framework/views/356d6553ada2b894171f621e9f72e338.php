...
function addToWishlist(productId){
    $.ajax({
        method: 'GET',
        url: '<?php echo e(route("wishlist.store", ":productId")); ?>'.replace(':productId', productId),
        beforeSend: function(){
            showLoader()
        },
        success: function(response){
...
<?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/frontend/layouts/global-scripts.blade.php ENDPATH**/ ?>