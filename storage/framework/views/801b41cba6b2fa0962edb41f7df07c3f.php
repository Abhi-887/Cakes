            ...
            $('.clear_db').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            method: 'POST',
                            url: "<?php echo e(route('admin.clear-database.destroy')); ?>",
                            data: {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/admin/clear-database/index.blade.php ENDPATH**/ ?>