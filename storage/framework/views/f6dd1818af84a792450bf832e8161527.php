<div class="tab-pane fade show" id="logo-setting" role="tabpanel" aria-labelledby="home-tab4">
    <div class="card">
        <div class="card-body border">
            <form action="<?php echo e(route('admin.logo-setting.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            $('.logo').css({
                'background-image': 'url(<?php echo e(asset(config("settings.logo"))); ?>)',
                'background-size': 'cover',
                'background-position': 'center center'
            })
            $('.footer_logo').css({
                'background-image': 'url(<?php echo e(asset(config("settings.footer_logo"))); ?>)',
                'background-size': 'cover',
                'background-position': 'center center'
            })
            $('.favicon').css({
                'background-image': 'url(<?php echo e(asset(config("settings.favicon"))); ?>)',
                'background-size': 'cover',
                'background-position': 'center center'
            })
            $('.breadcrumb').css({
                'background-image': 'url(<?php echo e(asset(config("settings.breadcrumb"))); ?>)',
                'background-size': 'cover',
                'background-position': 'center center'
            })
        })
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/admin/setting/sections/logo-setting.blade.php ENDPATH**/ ?>