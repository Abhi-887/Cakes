				...
				<div class="row">
					<div class="col-12 wow fadeInUp" data-wow-duration="1s">
						<div class="fp__contact_info">
							...
							<div class="text">
								<h3>call</h3>
								<p><?php echo e(@$contact->phone_one); ?></p>
								<p><?php echo e(@$contact->phone_two); ?></p>
							</div>
						</div>
					</div>
					<div class="col-12 wow fadeInUp" data-wow-duration="1s">
						<div class="fp__contact_info">
							...
							<div class="text">
								<h3>mail</h3>
								<p><?php echo e(@$contact->mail_one); ?></p>
								<p><?php echo e(@$contact->mail_two); ?></p>
							</div>
						</div>
					</div>
				   <!-- <div class="col-12 wow fadeInUp" data-wow-duration="1s">
					...
					<div class="mt-3"><?php echo @$contact->address; ?></div>
				</div>
					...
					<div class="row mt_100 xs_mt_70">
						<div class="col-xl-12 wow fadeInUp" data-wow-duration="1s">
							<div class="fp__contact_map">
								<iframe
									src="<?php echo e(@$contact->map_link); ?>"
				...
				<div class="row">
					<div class="col-12 wow fadeInUp" data-wow-duration="1s">
						<div class="fp__contact_info">
							...
							<div class="text">
								<h3>call</h3>
								<p><?php echo e($contact2->phone_one); ?></p>
								<p><?php echo e(@$contact2->phone_two); ?></p>
					...
					<div class="col-12 wow fadeInUp" data-wow-duration="1s">
						<div class="fp__contact_info">
							...
							<div class="text">
								<h3>mail</h3>
								<p><?php echo e(@$contact2->mail_one); ?></p>
								<p><?php echo e(@$contact2->mail_two); ?></p>
							</div>
						</div>
					</div>
				   <!-- <div class="col-12 wow fadeInUp" data-wow-duration="1s">
					...
					<div class="mt-3"><?php echo @$contact2->address; ?></div>
				</div>
				<div class="fp__contact_form_area mt_100 xs_mt_70">
					...
					<div class="row mt_100 xs_mt_70">
						<div class="col-xl-12 wow fadeInUp" data-wow-duration="1s">
							<div class="fp__contact_map">
								<iframe
									src="<?php echo e(@$contact2->map_link); ?>"
									style="border:0;" allowfullscreen="" loading="lazy"
									referrerpolicy="no-referrer-when-downgrade"></iframe>
							</div>
						</div>
    ...
    <script>
        $(document).ready(function(){
            $('.fp__contact_form').on('submit', function(e){
                ...
                $.ajax({
                    method: 'POST',
                    url: '<?php echo e(route("contact.send-message")); ?>',
                    data: formData,
                    beforeSend: function(){
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/frontend/pages/contact.blade.php ENDPATH**/ ?>