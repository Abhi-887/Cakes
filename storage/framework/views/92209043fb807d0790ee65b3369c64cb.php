                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <select name="show_at_home" class="form-control" id="">
                        <option <?php if($slider->show_at_home === 0): echo 'selected'; endif; ?> value="0">Home</option>
                        <option <?php if($slider->show_at_home === 1): echo 'selected'; endif; ?> value="1">Wedding Cakes</option>
						<option <?php if($slider->show_at_home === 2): echo 'selected'; endif; ?> value="2">Birthday & Party Cakes</option>
                        <option <?php if($slider->show_at_home === 3): echo 'selected'; endif; ?> value="3">Voucher Redemption</option>			
						<option <?php if($slider->show_at_home === 4): echo 'selected'; endif; ?> value="4">About Us</option>
                        <option <?php if($slider->show_at_home === 5): echo 'selected'; endif; ?> value="5">Contact Us</option>
                    </select>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/admin/slider/edit.blade.php ENDPATH**/ ?>