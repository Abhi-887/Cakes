    ...
    <script>
        $(document).ready(function(){
            ...
            $('.fp_chat_message').on('click', function(){
                ...
                $.ajax({
                    method: 'GET',
                    url: '<?php echo e(route("chat.get-conversation", ":senderId")); ?>'.replace(":senderId", senderId),
                    beforeSend: function() {
                    ...
                    let html =  `
                        <div class="fp__chating tf_chat_right">
                            <div class="fp__chating_img">
                                <img src="<?php echo e(asset(auth()->user()->avatar)); ?>" alt="person"
                                    class="img-fluid w-100" style="border-radius: 50%;">
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/frontend/dashboard/sections/message-section.blade.php ENDPATH**/ ?>