            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <h5>#<?php echo e($order->invoice_id); ?></h5>
                            </td>
                            <td>
                                <p><?php echo e(date('F d, Y', strtotime($order->created_at))); ?></p>
                            </td>
                            <td>
                                <?php if($order->order_status === 'pending'): ?>
                                <span class="active">Pending</span>
                                <?php elseif($order->order_status === 'in_process'): ?>
                            ...
                            <td>
                                <h5><?php echo e(currencyPosition($order->grand_total)); ?></h5>
                            </td>
                            <td><a class="view_invoice" onclick="viewInvoice('<?php echo e($order->id); ?>')">View Details</a></td>
                        </tr>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/webchall/cakes.gprlive.com/resources/views/frontend/dashboard/sections/order-section.blade.php ENDPATH**/ ?>