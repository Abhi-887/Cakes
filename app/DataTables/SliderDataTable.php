            ...
            ->addColumn('background_image', function($query){
			 ...
			 ->addColumn('show_at_home', function($query){
                if($query->show_at_home === 0){
                    ...
                    return '<span class="badge badge-primary">Wedding Cakes</span>';
                }if($query->show_at_home === 2){
                    return '<span class="badge badge-primary">Birthday & Party Cakes</span>';
                }if($query->show_at_home === 3){
                    return '<span class="badge badge-primary">Voucher Redemption</span>';
                }if($query->show_at_home === 4){
                    return '<span class="badge badge-primary">About Us</span>';
                }if($query->show_at_home === 5){
                    return '<span class="badge badge-primary">Contact Us</span>';
                }else {
