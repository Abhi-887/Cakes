    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $attribute = "<a href= '" . route('admin.attributes.createOrEdit', $query->id) . "' class='btn btn-secondary mr-2'><i class='fa-solid fa-network-wired'></i></a>";
                /**$attributedit = "<a href= '".route('admin.attribute.edit', $query->id)."' class='btn btn-secondary mr-2'><i class='fa-solid fa-network-wired'></i></a>";*/
