    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $attribute = "<a href= '" . route('admin.attributes.createOrEdit', $query->id) . "' class='mr-2 btn btn-secondary'><i class='fa-solid fa-network-wired'></i></a>";
                /**$attributedit = "<a href= '".route('admin.attribute.edit', $query->id)."' class='mr-2 btn btn-secondary'><i class='fa-solid fa-network-wired'></i></a>";*/
                ...
                return $attribute . $edit . $delete . $more;
            })
