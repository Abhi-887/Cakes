                        ...
                        <form action="" id="v_add_to_cart_form">
                            ...
                            <ul class="flex-wrap details_button_area d-flex">
                                @if ($product->quantity === 0 || $product->out_of_stock)
                                    <li><a class="px-3 py-2 background-light-gray rounded-pill bg-danger"
                                            href="javascript:;">Out of
                                            Stock</a></li>
                                @else
                                    <li><a class="px-3 py-2 background-light-gray rounded-pill v_submit_button"
                                            href="#">Add To
                                            Cart</a></li>
                                @endif
