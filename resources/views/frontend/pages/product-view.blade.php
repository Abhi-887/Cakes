        ...
        <div class="col-xl-6 col-sm-6">
            ...
            <div class="mt-2 fp__contact_form_input form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="variant_{{ $variant->id }}"
                        id="variant_{{ $variant->id }}_{{ $variantItem->id }}" value="{{ $variantItem->id }}" {{
                        $variantItem->is_default == 1 ? 'checked' : '' }} required>
                ...
                <div class="fp__menu_details_text">
                    ...
                    <form action="" id="v_add_to_cart_form">
                        ...
                        <div class="my-4">
                            ...
                            <div class="my-4">
                                <input class="w-0 me-2" type="checkbox" name="chocolate" value="35" id="chocolate">
                                <label for="chocolate">Chocolate +£35.00</label>
                            </div>
                            <div class="">
                                <input class="w-0 me-2" type="checkbox" name="toffee" value="35" id="toffee">
