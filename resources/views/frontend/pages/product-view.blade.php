                        ...
                        <form action="" id="v_add_to_cart_form">
                            ...
                            <div class="extra-options">
                                ...
                                <label><input type="checkbox" name="extra-plain-sponge" value="35"> Plain Sponge
                                    +£35.00</label>
                                <label><input type="checkbox" name="extra-chocolate" value="35"> Chocolate
                                    +£35.00</label>
                            ...
                            <div class="gallery">
                                <div class="row">
                                    <div class="my-3 col-md-4">
                                        ...
                                        <h5 class="my-3 color-dark-gray fw-semibold">Frosted Glass Block</h5>
                                    </div>
                                    <div class="my-3 col-md-4">
                                        <div class="cake-stand">
                                            <img class="rounded-3"
                                        ...
                                        <h5 class="my-3 color-dark-gray fw-semibold">Low Frosted Glass Block</h5>
                                    </div>
                                    <div class="my-3 col-md-4">
                                        <div class="cake-stand">
                                            <img class="rounded-3"
                                        ...
                                        <h5 class="my-3 color-dark-gray fw-semibold">Hovering Black Glass</h5>
                                    </div>
                                    ...
                                    <div class="my-3 col-md-4">
                                        ...
                                        <h5 class="my-3 color-dark-gray fw-semibold">Chrome Mirror</h5>
                                    </div>
                                    ...
                                    <div class="my-3 col-md-4">
                                        ...
                                        <h5 class="my-3 color-dark-gray fw-semibold">Chrome</h5>
                                    </div>
                                    ...
                                    <div class="my-3 col-md-4">
                                        ...
                                        <h5 class="my-3 color-dark-gray fw-semibold">Low Chrome</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                            ...
                            <div class="fp__review_area">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <h4>write a Review</h4>
                                        <div class="mt-4 alert alert-warning">Please login first to add review.</div>
                                    </div>
                                    @endauth
                                </div>
                            </div>
...
>>>>>>> e92dd51080690f2d04afcda299d8dac8c6f494b5
