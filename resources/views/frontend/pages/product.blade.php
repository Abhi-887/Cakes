            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-md-4">
                    <select class="py-2 form-control rounded-pill" name="parent_category" id="parent_category">
                        ...
                        @foreach ($categories as $category)
                        @if ($category->parent == 0)
                        <option value="{{ $category->id }}" {{ request()->parent_category == $category->id ? 'selected'
                            : '' }}>
                            {{ $category->name }}</option>
                        @endif
                        @endforeach
                ...
                <div class="col-xl-3 col-md-4">
                    <select class="py-2 form-control rounded-pill" name="sub_category" id="sub_category">
                        ...
                        @foreach ($categories as $category)
                        @if ($category->parent != 0)
                        <option value="{{ $category->id }}" data-parent="{{ $category->parent }}" {{ request()->
                            sub_category == $category->id ? 'selected' : '' }}>
                            {{ $category->name }}</option>
                        @endif
                        @endforeach
                    </select>
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                        <div class="fp__menu_item">
                            <div class="fp__menu_item_img">
                                ...
                                <a class="category" href="#">{{ $product->sub_category->name ?? '' }}</a>
                            </div>
                            <div class="fp__menu_item_text">
                                @if ($product->reviews_avg_rating)
                                    <p class="rating">
