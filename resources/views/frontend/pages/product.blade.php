        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                <div class="fp__menu_item">
                    ...
                    <a class="category bg-light px-2 py-1 fw-semibold" href="#">{{ $product->subCategory->name ?? ''
                        }}</a>
                    <div class="fp__menu_item_text">
                        ...
                        @endif
                        <a class="title my-3" href="{{ route('product.show', $product->slug) }}">{{ $product->name
                            }}</a>
                        <p
                        ...
                        <ul class="flex-wrap d-flex justify-content-center">
                            ...
                            <li><a class="background-light-gray" href="{{ route('product.show', $product->slug) }}"><i
