            ...
            <div class="row align-items-center">
                <div class="col-md-6 my-3 my-md-0">
                    <div class="">
                        ...
                        <p><strong>Main Duties:</strong> Front-of-house customer service for coffees & cake slices, baking
                            and
                            cake
                            decorating (ideal candidate will have an enjoyment for baking and cake decorating). Have barista
                            ...
                            maintain
                            a
                            calm demeanour in busy periods, and provide a consistently high standard of customer service.
                        </p>
        ...
        <div class="row justify-content-center">
            <div class="col-8">
                <form class="" action="{{ route('work-with-us.store') }}" method="POST"
                    ...
                    <div class="mt-4">
                        <label for="relevantExperience">Please detail any relevant experience that you feel would be
                            beneficial
                            for
                            the role(s): *</label>
                        <div class="fp__contact_form_input form-group mt-3">
