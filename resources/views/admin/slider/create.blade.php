                ...
                <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id" class="form-control">
                            ...
                            @foreach ($categories as $slidercategory)
                                <option value="{{ $slidercategory->id }}">{{ $slidercategory->category }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="show_at_home" class="form-control" id="">
                            ...
                            <option selected value="1">Wedding Cakes</option>
                            <option value="2">Birthday & Party Cakes</option>
                            <option value="3">Voucher Redemption</option>
