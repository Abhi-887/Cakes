                                ...
                                <ul class="flex flex-column gap14">
                                    <li class="product-item">
                                        ...
                                        <div class="flex items-center justify-between flex-grow">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/2.png') }}" alt="">
                                            </div>
                                            <div>
                                    ...
                                    <li class="product-item">
                                        ...
                                        <div class="flex items-center justify-between flex-grow">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/3.png') }}" alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                                <div class="text-tiny">$27.00</div>
                                    ...
                                    <li class="product-item">
                                        ...
                                        <div class="flex items-center justify-between flex-grow">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/1.png') }}" alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                                <div class="text-tiny">$27.00</div>
                                    ...
                                    <li class="product-item">
                                        ...
                                        <div class="flex items-center justify-between flex-grow">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/4.png') }}" alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                                <div class="text-tiny">$27.00</div>
                                    ...
                                    <li class="product-item">
                                        ...
                                        <div class="flex items-center justify-between flex-grow">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/5.png') }}" alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                                <div class="text-tiny">$27.00</div>
