                            ...
                            <div class="wg-table table-top-product">
                                <ul class="flex flex-column gap14">
                                    <li class="product-item">
                                        <div class="image">
                                            <img src="{{ asset('admin2/assets/images/products/1.png') }}" alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/2.png') }}"
                                                    alt="">
                                            </div>
                                            <div>
                                    ...
                                    <li class="product-item">
                                        <div class="image">
                                            <img src="{{ asset('admin2/assets/images/products/2.png') }}" alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow">
                                            <div class="name">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/3.png') }}"
                                                    alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                    ...
                                    <li class="product-item">
                                        <div class="image">
                                            <img src="{{ asset('admin2/assets/images/products/3.png') }}" alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow">
                                            <div class="name">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/1.png') }}"
                                                    alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                    ...
                                    <li class="product-item">
                                        <div class="image">
                                            <img src="{{ asset('admin2/assets/images/products/4.png') }}" alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow">
                                            <div class="name">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/4.png') }}"
                                                    alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                                    ...
                                    <li class="product-item">
                                        <div class="image">
                                            <img src="{{ asset('admin2/assets/images/products/5.png') }}" alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow">
                                            <div class="name">
                                            ...
                                            <div class="country">
                                                <img src="{{ asset('admin2/assets/images/country/5.png') }}"
                                                    alt="">
                                            </div>
                                            <div>
                                                <div class="body-title-2 mb-3">-15%</div>
                        ...
                        <div class="wg-box">
                            ...
                            <div class="wg-table table-product-overview">
                                ...
                                <ul class="flex flex-column gap10">
                                    ...
                                    <li class="product-item gap14">
                                        <div class="image">
                                            <img src="{{ asset('admin2/assets/images/products/10.png') }}"
                                                alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow">
                                            <div class="name">
                                ...
                                <ul class="flex flex-column gap18">
                                    <li class="product-item gap14">
                                        <div class="image small">
                                            <img src="{{ asset('admin2/assets/images/products/11.png') }}"
                                                alt="">
                                        </div>
                                    ...
                                    <li class="product-item gap14">
                                        <div class="image small">
                                            <img src="{{ asset('admin2/assets/images/products/12.png') }}"
                                                alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow gap10">
                                            <div class="name">
                                    ...
                                    <li class="product-item gap14">
                                        <div class="image small">
                                            <img src="{{ asset('admin2/assets/images/products/13.png') }}"
                                                alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow gap10">
                                            <div class="name">
                                    ...
                                    <li class="product-item gap14">
                                        <div class="image small">
                                            <img src="{{ asset('admin2/assets/images/products/14.png') }}"
                                                alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow gap10">
                                            <div class="name">
                                    ...
                                    <li class="product-item gap14">
                                        <div class="image small">
                                            <img src="{{ asset('admin2/assets/images/products/15.png') }}"
                                                alt="">
                                        </div>
                                        <div class="flex items-center justify-between flex-grow gap10">
                                            <div class="name">
